	...
	public void initSieges() {
		...
		CronService.getInstance().schedule(new Runnable() {
			...
			public void run() {
				...
				int bossId = calendar.get(Calendar.DAY_OF_WEEK) != Calendar.SATURDAY ? 218553 : 219359;
				if (cl && cr) {
					if (tiamarantaEyeBoss.containsKey(bossId) && tiamarantaEyeBoss.get(bossId).isSpawned())
						...
						tiamarantaEyeBoss.put(bossId, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(600040000,
								bossId, 759.0958f, 765.6816f, 1226.5004f, (byte) 0), 1));
						tiamarantaEyeBoss.put(283074, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(600040000,
								283074, 754.84625f, 819.98828f, 1223.957f, (byte) 0), 1));
						tiamarantaEyeBoss.put(283076, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(600040000,
								283076, 754.90234f, 712.99042f, 1223.957f, (byte) 0), 1));
					}
