...
public class SM_PLAYER_INFO extends AionServerPacket {
    ...
    protected void writeImpl(AionConnection con) {
        ...
        String accessTagFormat = "%s";
        String weddingTagFormat = "";
        String advancedTagFormat = "";
        ...
        if (player.getClientConnection() != null)
        {
            if (AdminConfig.CUSTOMTAG_ENABLE)
            {
                ...
                {
                    case 1:
                        accessTagFormat = AdminConfig.CUSTOMTAG_ACCESS1;
                        break;
                    case 2:
                        accessTagFormat = AdminConfig.CUSTOMTAG_ACCESS2;
                        break;
                    case 3:
                        accessTagFormat = AdminConfig.CUSTOMTAG_ACCESS3;
                        break;
                    case 4:
                        accessTagFormat = AdminConfig.CUSTOMTAG_ACCESS4;
                        break;
                    case 5:
                        accessTagFormat = AdminConfig.CUSTOMTAG_ACCESS5;
                        break;
                }
            }
        ...
        writeS(String.format(accessTagFormat, weddingTagFormat + player.getName() + advancedTagFormat));
